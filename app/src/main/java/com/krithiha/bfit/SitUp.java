...
public class SitUp extends AppCompatActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        preferencesManager.setActivity("Sit Up");
        preferencesManager.setActivityStartTime((new Date()) + "");

        Button btn_accc = (Button)findViewById(R.id.btn_accc);
        Button btn_asss = (Button)findViewById(R.id.btn_asss);
        ...
        btn_asss.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    protected void onDestroy() {
        ...
        DBActivity dbActivity = new DBActivity(SitUp.this);
