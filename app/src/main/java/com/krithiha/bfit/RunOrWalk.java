...
public class RunOrWalk extends AppCompatActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // getSupportActionBar().setDisplayHomeAsUpEnabled(false);
        ...
        setContentView(R.layout.run_walk);
        ...
        preferencesManager.setActivity("Run & Walk");
    ...
    protected void onDestroy() {
        ...
        DBActivity dbActivity = new DBActivity(RunOrWalk.this);
